...
cmake -DCMAKE_BUILD_TYPE=Release -Bbuildeigen -Seigen && sudo cmake --build buildeigen -j$(nproc) --target install 
...
cmake -DCMAKE_BUILD_TYPE=Release -Bbuildpcl -Spcl && sudo cmake --build buildpcl -j$(nproc) && sudo cmake --install buildpcl
