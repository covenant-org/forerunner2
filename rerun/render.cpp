...
// Reflects and logs fields of any dynamic message
...
// Converts capnp::Text to std::string
...
// Generic rendering for non-specialized messages
...
// Calculates the radius for the marker
...
// Renders visualization_msgs::Marker
...
// =====================
// MarkerArray functions
// =====================

// Renders visualization_msgs::MarkerArray
 ...
 public:
  PointSubscriber(Core::ArgumentParser args)
    ...
    topics_client_ = this->create_action_client<TopicsListRequest, TopicsListResponse>(
        "registry/topics");
    refresh_topics();
    refresh_thread_ = std::thread(&PointSubscriber::topic_refresh_loop, this);
  }
